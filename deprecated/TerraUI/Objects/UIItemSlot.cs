...
namespace TerraUI.Objects {
    public class UIItemSlot : UIObject {
        ...
        public override void OnLeftClick() {
            if(Main.mouseItem.stack < 1 && item.type == ItemID.None) {
                return;
            }
        ...
        public static void Swap(ref Item item1, ref Item item2) {
        ...
        public void OnDrawItem(SpriteBatch spriteBatch) {
            ...
            if(Item.stack > 1) {
                ChatManager.DrawColorCodedStringWithShadow(
                    spriteBatch,
                    (ReLogic.Graphics.DynamicSpriteFont)Terraria.GameContent.FontAssets.ItemStack,
                    Item.stack.ToString(),
