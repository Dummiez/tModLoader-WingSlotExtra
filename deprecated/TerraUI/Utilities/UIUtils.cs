...
namespace TerraUI.Utilities {
    public static class UIUtils {
        ...
        public static Texture2D GetContextTexture(int context) {
            ...
            {
                ItemSlot.Context.EquipAccessory or ItemSlot.Context.EquipArmor or ItemSlot.Context.EquipGrapple or ItemSlot.Context.EquipMount or ItemSlot.Context.EquipMinecart or ItemSlot.Context.EquipPet or ItemSlot.Context.EquipLight => TextureAssets.InventoryBack3.Value,
                ItemSlot.Context.EquipArmorVanity or ItemSlot.Context.EquipAccessoryVanity => TextureAssets.InventoryBack8.Value,
                ItemSlot.Context.EquipDye => TextureAssets.InventoryBack12.Value,
                ItemSlot.Context.ChestItem => TextureAssets.InventoryBack5.Value,
                ItemSlot.Context.BankItem => TextureAssets.InventoryBack2.Value,
                ItemSlot.Context.GuideItem or ItemSlot.Context.PrefixItem or ItemSlot.Context.CraftingMaterial => TextureAssets.InventoryBack4.Value,
                ItemSlot.Context.TrashItem => TextureAssets.InventoryBack7.Value,
                ItemSlot.Context.ShopItem => TextureAssets.InventoryBack9.Value,
